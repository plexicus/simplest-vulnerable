...
if(isset($_GET['id'])) {
    ...
    // Irvine and AI did this

    $stmt = $conn->prepare("SELECT * FROM usuarios WHERE id = ?"); // Uso de consulta parametrizada
    $stmt->bind_param("i", $id); // Enlace del parámetro id como un entero
    $stmt->execute();
